...
#define PTE_VMPL 0x0400 /* VMPL-MM managed area */
...
#define SEG_LDT	 (0x2UL << 40) /* 64-bit local descriptor segment */
#define SEG_TSSA (0x9UL << 40) /* Available 64-bit TSS */
#define SEG_TSSB (0xaUL << 40) /* Busy 64-bit TSS */
#define SEG_CG	 (0xcUL << 40) /* 64-bit Call Gate */
#define SEG_IG	 (0xeUL << 40) /* 64-bit Interrupt Gate */
#define SEG_TG	 (0xfUL << 40) /* 64-bit Trap Gate */

#define SEG_DPL(x) (((x)&3UL) << 45) /* Descriptor privilege level */
#define SEG_P	   (ONE << 47) /* Present */
#define SEG_AVL    (ONE << 52) /* Available for use by system software */
