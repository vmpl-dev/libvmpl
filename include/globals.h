...
/// 15
#define SVSM_REASON_CODE_SET 15
/// 0
#define SVSM_TERM_GENERAL 0
/// 1
#define SVSM_TERM_ENOMEM 1
/// 2
#define SVSM_TERM_UNHANDLED_VC 2
/// 3
#define SVSM_TERM_PSC_ERROR 3
/// 4
#define SVSM_TERM_SET_PAGE_ERROR 4
/// 5
#define SVSM_TERM_NO_GHCB 5
/// 6
#define SVSM_TERM_GHCB_RESP_INVALID 6
/// 7
#define SVSM_TERM_FW_CFG_ERROR 7
/// 8
#define SVSM_TERM_BIOS_FORMAT 8
/// 9
#define SVSM_TERM_NOT_VMPL0 9
/// 10
#define SVSM_TERM_VMPL0_SEV_FEATURES 10
/// 11
#define SVSM_TERM_INCORRECT_VMPL 11
/// 12
#define SVSM_TERM_VMPL1_SEV_FEATURES 12
