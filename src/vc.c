...
/// 2
const uint64_t GHCB_PROTOCOL_MIN = 2;
/// 2
const uint64_t GHCB_PROTOCOL_MAX = 2;

/// Bits zero, one and four
const uint64_t GHCB_SVSM_FEATURES = BIT(0) | BIT(1) | BIT(4);

/// 0xfff
const uint64_t GHCB_MSR_INFO_MASK = 0xfff;
...
/// 0x2
const uint64_t GHCB_MSR_SEV_INFO_REQ = 0x002;
/// 0x1
const uint64_t GHCB_MSR_SEV_INFO_RES = 0x001;
#define GHCB_MSR_PROTOCOL_MIN(x) (((x) >> 32) & 0xffff)
#define GHCB_MSR_PROTOCOL_MAX(x) (((x) >> 48) & 0xffff)

// MSR protocol: GHCB registration
/// 0x12
const uint64_t GHCB_MSR_REGISTER_GHCB_REQ = 0x12;
#define GHCB_MSR_REGISTER_GHCB(x) ((x) | GHCB_MSR_REGISTER_GHCB_REQ)
/// 0x13
const uint64_t GHCB_MSR_REGISTER_GHCB_RES = 0x13;

// MSR protocol: Hypervisor feature support
/// 0x80
const uint64_t GHCB_MSR_HV_FEATURE_REQ = 0x080;
/// 0x81
const uint64_t GHCB_MSR_HV_FEATURE_RES = 0x081;
#define GHCB_MSR_HV_FEATURES(x) (GHCB_MSR_DATA(x) >> 12)

// MSR protocol: Termination request
/// 0x100
const uint64_t GHCB_MSR_TERMINATE_REQ = 0x100;

/// 0
const uint32_t RESCIND = 0;
/// 1
const uint32_t VALIDATE = 1;

// VMGEXIT exit codes
/// 0x27
const uint64_t GHCB_NAE_DR7_READ = 0x27;
/// 0x37
const uint64_t GHCB_NAE_DR7_WRITE = 0x37;
/// 0x6e
const uint64_t GHCB_NAE_RDTSC = 0x6e;
/// 0x6f
const uint64_t GHCB_NAE_RDPMC = 0x6f;
/// 0x72
const uint64_t GHCB_NAE_CPUID = 0x72;
/// 0x76
const uint64_t GHCB_NAE_INVD = 0x76;
/// 0x7b
const uint64_t GHCB_NAE_IOIO = 0x7b;
/// 0x7c
const uint64_t GHCB_NAE_MSR_PROT = 0x7c;
/// 0x81
const uint64_t GHCB_NAE_VMMCALL = 0x81;
/// 0x87
const uint64_t GHCB_NAE_RDTSCP = 0x87;
/// 0x89
const uint64_t GHCB_NAE_WBINVD = 0x89;
/// 0x80000010
const uint64_t GHCB_NAE_PSC = 0x80000010;
/// 0x80000011
const uint64_t GHCB_NAE_SNP_GUEST_REQUEST = 0x80000011;
/// 0x800000112
const uint64_t GHCB_NAE_SNP_EXTENDED_GUEST_REQUEST = 0x80000012;
/// 0x80000013
const uint64_t GHCB_NAE_SNP_AP_CREATION = 0x80000013;
/// 1
const uint64_t SNP_AP_CREATE_IMMEDIATE = 1;
/// 0x80000017
const uint64_t GHCB_NAE_GET_APIC_IDS = 0x80000017;
/// 0x80000018
const uint64_t GHCB_NAE_RUN_VMPL = 0x80000018;
...
/// Bit 9
const uint64_t IOIO_ADDR_64 = BIT(9);
/// Bit 6
const uint64_t IOIO_SIZE_32 = BIT(6);
/// Bit 5
const uint64_t IOIO_SIZE_16 = BIT(5);
/// Bit 4
const uint64_t IOIO_SIZE_8 = BIT(4);
/// Bit 0
const uint64_t IOIO_TYPE_IN = BIT(0);
...
static __always_inline void sev_es_wr_ghcb_msr(uint64_t val)
{
	uint32_t low, high;
